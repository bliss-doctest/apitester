...
import de.devbliss.apitester.transport.UploadPoster;
 ...
 * <li>
 * If you want to instantiate this class and use <b>specific factories</b> (like mocks for example), just make: <code>
 ...
 * <ul>
 * <li>if you need the <b>default factories</b>, you do not have to do anything since Guice is going to use the default
 * constructor of {@link ApiTest}.</li>
 * <li>if you need some <b>specifics factories</b>, you just have to bind these factories in your Guice module like
 * this: <code>
...
public class ApiTest {
    ...
    public Context postUpload(URI uri, File fileToUpload, String paramName) throws IOException {
        return UploadPoster.post(uri, fileToUpload, paramName);
    }

    public Context postUpload(URI uri, File fileToUpload, String paramName, Map<String, String> additionalHeaders) throws IOException {
        return UploadPoster.post(uri, fileToUpload, paramName, additionalHeaders);
    }
